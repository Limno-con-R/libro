...
\includegraphics{02-RegMult_files/figure-latex/plot1-1.pdf} \includegraphics{02-RegMult_files/figure-latex/plot1-2.pdf} \includegraphics{02-RegMult_files/figure-latex/plot1-3.pdf} \includegraphics{02-RegMult_files/figure-latex/plot1-4.pdf}
...
\includegraphics{02-RegMult_files/figure-latex/plot2-1.pdf} \includegraphics{02-RegMult_files/figure-latex/plot2-2.pdf} \includegraphics{02-RegMult_files/figure-latex/plot2-3.pdf} \includegraphics{02-RegMult_files/figure-latex/plot2-4.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Chequeo de normalidad de los datos en la amtriz ambiental}
\FunctionTok{library}\NormalTok{(MVN)}
\NormalTok{mvn.env }\OtherTok{\textless{}{-}} \FunctionTok{mvn}\NormalTok{(env, }\AttributeTok{mvnTest =} \StringTok{"mardia"}\NormalTok{)}
\NormalTok{mvn.env}\SpecialCharTok{$}\NormalTok{Descriptives}\SpecialCharTok{$}\NormalTok{Skew }\CommentTok{\# skwe \textless{} 2 }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mvn.env}\SpecialCharTok{$}\NormalTok{multivariateNormality}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{p value}\StringTok{\textasciigrave{}}\CommentTok{\#p{-}valores \textgreater{} 0.05, no tenemos evidencia para rechazar la multinomralidad de los datos. }
\end{Highlighting}
\end{Shaded}
...
## + DRP      1 23.525 1.3845  0.245   
## + DIN      1 23.810 1.1098  0.320   
## + SUVA254  1 24.037 0.8944  0.460   
## + TP       1 24.087 0.8474  0.480   
## + pH       1 24.092 0.8425  0.510   
## + TH       1 24.081 0.8529  0.525   
## + E2_E3    1 24.382 0.5712  0.775   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##           Df    AIC      F Pr(>F)  
## + a440     1 18.018 2.4546  0.025 *
## + pH       1 19.078 1.4506  0.130  
## + DRP      1 19.089 1.4399  0.130  
## + TN       1 19.061 1.4660  0.150  
## + E2_E3    1 19.284 1.2616  0.255  
## + DIN      1 19.478 1.0851  0.340  
## + DOC      1 19.703 0.8828  0.490  
## + TH       1 19.807 0.7900  0.645  
## + TP       1 19.883 0.7230  0.700  
...
## + TH       1 18.889 0.9289  0.495  
## + DOC      1 18.935 0.8905  0.550  
## + E2_E3    1 18.937 0.8890  0.550  
## + SUVA254  1 19.014 0.8242  0.555  
## + DIN      1 19.423 0.4831  0.970  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## + TP       1 18.175 1.5445  0.120  
## + TN       1 18.218 1.5069  0.120  
## + DRP      1 18.257 1.4724  0.160  
## + TH       1 18.889 0.9289  0.490  
## + E2_E3    1 18.937 0.8890  0.495  
...
## + DO     1 250.33 0.9122  0.630   
## + Alk    1 250.54 0.7069  0.815   
## + Cond   1 250.57 0.6747  0.930   
...
## + DO    1 249.01 0.8576  0.660   
## + Cond  1 249.16 0.7171  0.870   
## + T     1 249.16 0.7173  0.880   
...
## + T     1 248.49 0.7454  0.915  
## + Alk   1 248.59 0.6523  0.935  
...
## 
##        Df    AIC      F Pr(>F)
## + Turb  1 248.59 1.3067  0.110
## + SS    1 249.01 0.9350  0.540
## + T     1 249.00 0.9490  0.570
## + IM    1 249.01 0.9351  0.600
## + DO    1 249.07 0.8830  0.635
## + Cond  1 249.07 0.8855  0.675
## + Alk   1 249.21 0.7610  0.745
## + pH    1 249.16 0.8072  0.780
\end{verbatim}
