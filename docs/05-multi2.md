...
## + TP       1 37.997 0.7466  0.485   
## + DRP      1 38.029 0.7166  0.505   
## + SUVA254  1 38.270 0.4923  0.620   
## + E2_E3    1 38.353 0.4154  0.705   
## + TH       1 38.425 0.3496  0.790   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: bio.trans ~ EC 
...
## + pH       1 32.870 2.3759  0.070 .
## + E2_E3    1 34.177 1.1501  0.300  
## + TN       1 34.291 1.0469  0.380  
## + DIN      1 34.608 0.7632  0.555  
## + DRP      1 34.851 0.5485  0.600  
## + TP       1 34.803 0.5910  0.605  
## + TH       1 34.873 0.5294  0.710  
## + DOC      1 34.986 0.4307  0.715  
## + SUVA254  1 35.170 0.2709  0.915  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##           Df    AIC      F Pr(>F)
## + pH       1 30.098 2.2393   0.10
## + TP       1 30.590 1.7964   0.17
## + DOC      1 31.460 1.0392   0.35
## + TN       1 31.422 1.0710   0.40
## + DRP      1 31.766 0.7802   0.50
## + SUVA254  1 31.840 0.7185   0.57
## + E2_E3    1 32.045 0.5477   0.74
## + TH       1 32.114 0.4904   0.74
## + DIN      1 32.500 0.1756   0.95
```
...
## + DOC      1 439.94 2.4469  0.095 . 
## + a440     1 440.76 1.6257  0.210   
## + TP       1 441.11 1.2859  0.310   
## + E2_E3    1 441.53 0.8848  0.320   
## + TH       1 441.34 1.0725  0.340   
## + DIN      1 441.51 0.9092  0.355   
## + SUVA254  1 441.40 1.0155  0.395   
## + pH       1 441.68 0.7432  0.455   
...
## + TP       1 436.22 1.2399  0.300  
## + SUVA254  1 436.60 0.8973  0.475  
## + DIN      1 436.64 0.8577  0.495  
## + DOC      1 436.87 0.6540  0.555  
...
## 
##           Df    AIC      F Pr(>F)  
## + pH       1 431.31 3.3846  0.055 .
## + TN       1 432.60 2.1715  0.120  
## + E2_E3    1 433.25 1.5858  0.210  
## + DOC      1 433.79 1.1182  0.360  
## + TH       1 434.31 0.6796  0.485  
## + SUVA254  1 434.40 0.6032  0.585  
## + TP       1 434.29 0.6956  0.590  
## + DRP      1 434.72 0.3418  0.755  
## + DIN      1 434.90 0.1953  0.820  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## CAP2      1  278096049  2.7168  0.149   
## CAP3      1   79898771  0.7806  0.503   
## Residual 16 1637764593                  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## + a440     1 22.817 2.0827  0.080 . 
## + DRP      1 23.525 1.3845  0.165   
## + DIN      1 23.810 1.1098  0.325   
## + TH       1 24.081 0.8529  0.445   
## + SUVA254  1 24.037 0.8944  0.455   
## + pH       1 24.092 0.8425  0.475   
## + TP       1 24.087 0.8474  0.510   
## + E2_E3    1 24.382 0.5712  0.850   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## + TN       1 19.061 1.4660  0.145  
## + pH       1 19.078 1.4506  0.150  
## + DRP      1 19.089 1.4399  0.190  
## + E2_E3    1 19.284 1.2616  0.230  
## + DIN      1 19.478 1.0851  0.315  
...
## + TN       1 18.218 1.5069  0.130  
## + TP       1 18.175 1.5445  0.165  
## + DRP      1 18.257 1.4724  0.175  
## + TH       1 18.889 0.9289  0.475  
## + DOC      1 18.935 0.8905  0.525  
## + E2_E3    1 18.937 0.8890  0.525  
## + SUVA254  1 19.014 0.8242  0.645  
...
## Model: cca(formula = data_cca ~ Turb + DO + T + Cond + pH + Chl.a + TN + TP + SS + OM + IM + Alk, data = env.r)
##          Df ChiSquare      F Pr(>F)  
## CCA1      1    0.5366 4.2011  0.015 *
## CCA2      1    0.3764 2.9464  0.012 *
## CCA3      1    0.3502 2.7417  0.035 *
## CCA4      1    0.2387 1.8686  0.695  
## CCA5      1    0.1981 1.5508  0.909  
...
## + pH     1 250.04 1.1904  0.250   
## + DO     1 250.33 0.9122  0.685   
## + Alk    1 250.54 0.7069  0.775   
## + Cond   1 250.57 0.6747  0.920   
## + T      1 250.57 0.6751  0.960   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: data_cca ~ Chl.a 
...
## + pH    1 248.96 0.8984  0.655   
## + DO    1 249.01 0.8576  0.705   
## + Cond  1 249.16 0.7171  0.850   
## + T     1 249.16 0.7173  0.890   
## + Alk   1 249.24 0.6383  0.910   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## + pH    1 248.64 0.9217  0.575  
## + Cond  1 248.68 0.8907  0.575  
...
## + IM     1 248.62 0.9454  0.525   
## + SS     1 248.62 0.9453  0.560   
## + T      1 248.62 0.9430  0.615   
## + DO     1 248.64 0.9231  0.570   
## + pH     1 248.64 0.9217  0.640   
## + Cond   1 248.68 0.8907  0.620   
## + Alk    1 248.69 0.8760  0.570   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step:  AIC=247.31
...
##         Df    AIC      F Pr(>F)   
## <none>     247.31                 
## + OM     1 247.69 1.4913  0.060 . 
## - TP     1 247.92 2.4923  0.005 **
## + TN     1 247.95 1.2471  0.200   
## + Turb   1 248.03 1.1693  0.235   
## + SS     1 248.15 1.0624  0.385   
## + IM     1 248.28 0.9348  0.560   
## + pH     1 248.31 0.9083  0.610   
## + DO     1 248.34 0.8866  0.685   
