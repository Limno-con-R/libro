...
## + a440     1 37.495 1.2229  0.285   
## + DIN      1 37.847 0.8874  0.380   
## + DRP      1 38.029 0.7166  0.525   
## + TP       1 37.997 0.7466  0.550   
## + SUVA254  1 38.270 0.4923  0.625   
## + E2_E3    1 38.353 0.4154  0.705   
## + TH       1 38.425 0.3496  0.870   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: bio.trans ~ EC 
...
## + DRP      1 34.851 0.5485  0.615  
## + TP       1 34.803 0.5910  0.620  
## + TH       1 34.873 0.5294  0.630  
## + DOC      1 34.986 0.4307  0.795  
...
## + TP       1 30.590 1.7964  0.195
## + DOC      1 31.460 1.0392  0.400
## + TN       1 31.422 1.0710  0.440
## + SUVA254  1 31.840 0.7185  0.510
## + DRP      1 31.766 0.7802  0.535
...
## + TH       1 441.34 1.0725  0.340   
## + DIN      1 441.51 0.9092  0.395   
## + SUVA254  1 441.40 1.0155  0.415   
## + E2_E3    1 441.53 0.8848  0.425   
## + pH       1 441.68 0.7432  0.475   
## + DRP      1 442.18 0.2880  0.795   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: biomass ~ EC 
...
## + E2_E3    1 435.03 2.3593  0.090 .
## + TN       1 435.40 1.9954  0.125  
## + pH       1 435.57 1.8349  0.125  
## + TP       1 436.22 1.2399  0.285  
## + DIN      1 436.64 0.8577  0.400  
## + SUVA254  1 436.60 0.8973  0.420  
## + DOC      1 436.87 0.6540  0.515  
## + TH       1 437.12 0.4337  0.730  
## + DRP      1 437.50 0.1099  0.900  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##           Df    AIC      F Pr(>F)  
## + pH       1 431.31 3.3846  0.060 .
## + TN       1 432.60 2.1715  0.090 .
## + E2_E3    1 433.25 1.5858  0.240  
## + DOC      1 433.79 1.1182  0.385  
## + TP       1 434.29 0.6956  0.555  
## + TH       1 434.31 0.6796  0.570  
## + SUVA254  1 434.40 0.6032  0.575  
## + DRP      1 434.72 0.3418  0.725  
...
```
## capscale(formula = biomass ~ EC + a440, data = env, add = "lingoes")
```
...
## CAP2      1  278096049  2.7168  0.174    
## CAP3      1   79898771  0.7806  0.491    
## Residual 16 1637764593                   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## + TN       1 20.679 4.3484  0.015 * 
## + DOC      1 22.618 2.2839  0.045 * 
## + a440     1 22.817 2.0827  0.085 . 
## + DRP      1 23.525 1.3845  0.185   
## + DIN      1 23.810 1.1098  0.370   
## + SUVA254  1 24.037 0.8944  0.430   
## + TH       1 24.081 0.8529  0.530   
## + TP       1 24.087 0.8474  0.540   
## + pH       1 24.092 0.8425  0.540   
...
## + TN       1 19.061 1.4660  0.155  
## + DRP      1 19.089 1.4399  0.180  
## + E2_E3    1 19.284 1.2616  0.245  
## + DIN      1 19.478 1.0851  0.335  
## + DOC      1 19.703 0.8828  0.575  
## + TH       1 19.807 0.7900  0.650  
## + TP       1 19.883 0.7230  0.705  
...
## 
##        Df    AIC      F Pr(>F)   
## - a440  1 18.715 2.4546  0.040 * 
## - EC    1 22.817 6.8831  0.005 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
##           Df    AIC      F Pr(>F)  
## + pH       1 17.824 1.8552  0.040 *
## + TN       1 18.218 1.5069  0.085 .
## + DRP      1 18.257 1.4724  0.105  
## + TP       1 18.175 1.5445  0.130  
## + DOC      1 18.935 0.8905  0.565  
## + E2_E3    1 18.937 0.8890  0.575  
## + SUVA254  1 19.014 0.8242  0.575  
## + TH       1 18.889 0.9289  0.580  
...
## + TN       1 18.201 1.2684  0.190  
## + E2_E3    1 18.352 1.1453  0.305  
## + TH       1 18.613 0.9364  0.520  
## + DOC      1 18.917 0.6956  0.755  
## + SUVA254  1 18.944 0.6748  0.780  
## + DIN      1 19.177 0.4931  0.960  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## Model: cca(formula = data_cca ~ Turb + DO + T + Cond + pH + Chl.a + TN + TP + SS + OM + IM + Alk, data = env.r)
##          Df ChiSquare      F Pr(>F)   
## CCA1      1    0.5366 4.2011  0.008 **
## CCA2      1    0.3764 2.9464  0.013 * 
## CCA3      1    0.3502 2.7417  0.044 * 
## CCA4      1    0.2387 1.8686  0.710   
## CCA5      1    0.1981 1.5508  0.939   
...
## + IM     1 249.34 1.8855  0.010 **
## + SS     1 249.43 1.7943  0.015 * 
## + pH     1 250.04 1.1904  0.225   
## + DO     1 250.33 0.9122  0.635   
## + Alk    1 250.54 0.7069  0.810   
## + Cond   1 250.57 0.6747  0.905   
## + T      1 250.57 0.6751  0.970   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: data_cca ~ Chl.a 
...
## + Turb  1 248.23 1.5960  0.050 * 
## + OM    1 248.57 1.2757  0.180   
## + TN    1 248.69 1.1618  0.270   
## + pH    1 248.96 0.8984  0.615   
## + DO    1 249.01 0.8576  0.650   
## + Cond  1 249.16 0.7171  0.850   
## + Alk   1 249.24 0.6383  0.895   
## + T     1 249.16 0.7173  0.935   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##        Df    AIC      F Pr(>F)  
## + OM    1 247.69 1.4913  0.025 *
## + TN    1 247.95 1.2471  0.140  
## + Turb  1 248.03 1.1693  0.295  
## + SS    1 248.15 1.0624  0.385  
## + pH    1 248.31 0.9083  0.595  
## + DO    1 248.34 0.8866  0.605  
## + IM    1 248.28 0.9348  0.615  
## + T     1 248.49 0.7454  0.900  
## + Alk   1 248.59 0.6523  0.915  
...
## + Turb  1 248.23 1.2906  0.155  
## + SS    1 248.62 0.9453  0.525  
## + T     1 248.62 0.9430  0.530  
## + IM    1 248.62 0.9454  0.545  
## + pH    1 248.64 0.9217  0.605  
## + Cond  1 248.68 0.8907  0.635  
## + DO    1 248.64 0.9231  0.645  
## + Alk   1 248.69 0.8760  0.685  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## + TN     1 247.95 1.2471  0.225   
## + Turb   1 248.03 1.1693  0.210   
## + SS     1 248.15 1.0624  0.350   
## + IM     1 248.28 0.9348  0.565   
## + pH     1 248.31 0.9083  0.565   
## + DO     1 248.34 0.8866  0.635   
## + T      1 248.49 0.7454  0.895   
