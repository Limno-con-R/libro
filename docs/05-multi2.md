...
## + pH       1 36.512 2.1912  0.100 .
## + DOC      1 36.689 2.0134  0.125  
## + a440     1 37.495 1.2229  0.315  
## + DIN      1 37.847 0.8874  0.435  
## + DRP      1 38.029 0.7166  0.510  
## + TP       1 37.997 0.7466  0.540  
## + SUVA254  1 38.270 0.4923  0.680  
## + E2_E3    1 38.353 0.4154  0.765  
## + TH       1 38.425 0.3496  0.805  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: bio.trans ~ EC 
...
## + E2_E3    1 34.177 1.1501  0.305   
## + TN       1 34.291 1.0469  0.350   
## + DIN      1 34.608 0.7632  0.500   
## + DRP      1 34.851 0.5485  0.560   
## + TP       1 34.803 0.5910  0.625   
## + TH       1 34.873 0.5294  0.685   
## + DOC      1 34.986 0.4307  0.780   
## + SUVA254  1 35.170 0.2709  0.900   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##           Df    AIC      F Pr(>F)
## + TP       1 30.590 1.7964  0.120
## + pH       1 30.098 2.2393  0.125
## + DOC      1 31.460 1.0392  0.315
## + TN       1 31.422 1.0710  0.335
## + DRP      1 31.766 0.7802  0.495
## + SUVA254  1 31.840 0.7185  0.555
## + E2_E3    1 32.045 0.5477  0.685
## + TH       1 32.114 0.4904  0.770
...
## + EC       1 435.62 7.3760  0.015 * 
## + DOC      1 439.94 2.4469  0.060 . 
## + a440     1 440.76 1.6257  0.210   
## + TP       1 441.11 1.2859  0.280   
## + SUVA254  1 441.40 1.0155  0.385   
## + E2_E3    1 441.53 0.8848  0.395   
## + TH       1 441.34 1.0725  0.415   
## + DIN      1 441.51 0.9092  0.425   
## + pH       1 441.68 0.7432  0.460   
...
## 
##           Df    AIC      F Pr(>F)  
## + EC       1 435.40 2.6933  0.040 *
## + a440     1 436.48 1.6577  0.185  
## + SUVA254  1 437.13 1.0618  0.320  
## + DRP      1 437.12 1.0782  0.325  
## + E2_E3    1 437.19 1.0098  0.345  
## + TP       1 437.06 1.1304  0.390  
## + pH       1 437.21 0.9892  0.390  
## + DIN      1 437.47 0.7613  0.510  
## + DOC      1 437.66 0.5935  0.640  
## + TH       1 438.01 0.2917  0.810  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: biomass ~ TN + EC 
## 
##           Df    AIC      F Pr(>F)  
## + a440     1 432.60 4.3460  0.025 *
## + E2_E3    1 435.08 1.9689  0.165  
## + pH       1 435.49 1.6090  0.230  
## + TP       1 435.74 1.3892  0.295  
## + SUVA254  1 435.95 1.2042  0.355  
## + DIN      1 436.44 0.7939  0.485  
## + DRP      1 436.81 0.4850  0.555  
## + DOC      1 436.73 0.5518  0.650  
## + TH       1 437.16 0.1987  0.915  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Step: biomass ~ TN + EC + a440 
## 
##           Df    AIC      F Pr(>F)  
## + pH       1 431.11 2.8573  0.065 .
## + E2_E3    1 432.94 1.2972  0.255  
## + DRP      1 433.30 1.0055  0.355  
## + TP       1 433.72 0.6718  0.590  
## + DOC      1 433.69 0.6962  0.620  
## + TH       1 434.12 0.3662  0.740  
## + SUVA254  1 434.15 0.3395  0.800  
## + DIN      1 434.27 0.2451  0.885  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
```
## capscale(formula = biomass ~ TN + EC + a440, data = env, add = "lingoes")
```
...
## CAP2      1  278096049  2.7168  0.166   
## CAP3      1   79898771  0.7806  0.486   
## Residual 16 1637764593                  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## + DRP      1 23.525 1.3845  0.165   
## + DIN      1 23.810 1.1098  0.295   
## + SUVA254  1 24.037 0.8944  0.435   
## + pH       1 24.092 0.8425  0.520   
## + TP       1 24.087 0.8474  0.530   
## + TH       1 24.081 0.8529  0.545   
...
## + DRP      1 19.089 1.4399  0.155  
## + E2_E3    1 19.284 1.2616  0.240  
## + DIN      1 19.478 1.0851  0.340  
## + DOC      1 19.703 0.8828  0.505  
## + TH       1 19.807 0.7900  0.605  
## + TP       1 19.883 0.7230  0.680  
## + SUVA254  1 20.175 0.4660  0.945  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## + DRP      1 18.257 1.4724  0.085 .
## + TP       1 18.175 1.5445  0.135  
## + TN       1 18.218 1.5069  0.145  
## + TH       1 18.889 0.9289  0.510  
...
## CCA2      1    0.3764 2.9464  0.009 **
## CCA3      1    0.3502 2.7417  0.045 * 
## CCA4      1    0.2387 1.8686  0.716   
...
## + IM     1 249.34 1.8855  0.040 * 
## + pH     1 250.04 1.1904  0.185   
## + DO     1 250.33 0.9122  0.620   
...
## + OM    1 248.57 1.2757  0.150   
## + TN    1 248.69 1.1618  0.255   
## + pH    1 248.96 0.8984  0.650   
## + DO    1 249.01 0.8576  0.710   
## + Cond  1 249.16 0.7171  0.875   
## + T     1 249.16 0.7173  0.895   
...
## + TN    1 247.95 1.2471  0.205  
## + Turb  1 248.03 1.1693  0.315  
## + SS    1 248.15 1.0624  0.360  
## + IM    1 248.28 0.9348  0.510  
## + pH    1 248.31 0.9083  0.645  
...
## + TN     1 248.10 1.4079  0.115   
## + Turb   1 248.23 1.2906  0.070 . 
## - TP     1 248.57 2.6824  0.005 **
## + IM     1 248.62 0.9454  0.475   
## + SS     1 248.62 0.9453  0.545   
## + T      1 248.62 0.9430  0.585   
## + DO     1 248.64 0.9231  0.610   
...
##         Df    AIC      F Pr(>F)   
## <none>     247.31                 
## + OM     1 247.69 1.4913  0.070 . 
## - TP     1 247.92 2.4923  0.005 **
## + TN     1 247.95 1.2471  0.140   
## + Turb   1 248.03 1.1693  0.300   
## + SS     1 248.15 1.0624  0.390   
## + IM     1 248.28 0.9348  0.555   
## + pH     1 248.31 0.9083  0.495   
## + DO     1 248.34 0.8866  0.660   
## + T      1 248.49 0.7454  0.885   
